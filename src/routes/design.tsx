      ...
      <EditorialShell title={<span className="hidden"></span>} intro="" eyebrow="">
          ...
          <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
            {items.map((p) => (
              <div 
                ...
                className="break-inside-avoid relative group rounded-2xl overflow-hidden bg-[#050505] cursor-pointer border border-white/5 transition-all duration-500 hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] md:hover:-translate-y-2 active:scale-[0.98]"
              >
                <img src={p.cover_image} alt={p.title} onContextMenu={(e) => e.preventDefault()} className="w-full h-auto object-cover group-hover:scale-[1.05] transition-transform duration-700 ease-out" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 border-t border-white/10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group relative p-6 md:p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-blue-500/50 md:hover:-translate-y-3 hover:bg-white/[0.04] hover:shadow-[0_20px_40px_-15px_rgba(59,130,246,0.2)] active:scale-[0.98] transition-all duration-500 overflow-hidden">
            ...
            <div className="group relative p-6 md:p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-pink-500/50 md:hover:-translate-y-3 hover:bg-white/[0.04] hover:shadow-[0_20px_40px_-15px_rgba(236,72,153,0.2)] active:scale-[0.98] transition-all duration-500 overflow-hidden lg:mt-8">
            ...
            <div className="group relative p-6 md:p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-indigo-500/50 md:hover:-translate-y-3 hover:bg-white/[0.04] hover:shadow-[0_20px_40px_-15px_rgba(99,102,241,0.2)] active:scale-[0.98] transition-all duration-500 overflow-hidden">
            ...
            <div className="group relative p-6 md:p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-yellow-500/50 md:hover:-translate-y-3 hover:bg-white/[0.04] hover:shadow-[0_20px_40px_-15px_rgba(234,179,8,0.2)] active:scale-[0.98] transition-all duration-500 overflow-hidden lg:mt-8">
        ...
        >
          ...
          >
            <div className="md:w-3/5 overflow-hidden bg-black/50 flex items-center justify-center">
              <img 
                src={selectedProject.cover_image} alt={selectedProject.title} onContextMenu={(e) => e.preventDefault()}
